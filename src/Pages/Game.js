  ...
  return (
    <div className='full-screen'>
          ...
          <Modal id='game-over'>
            <div className='game-over'>
              <div className='main-menu'>
                ...
                <Link className='btn secondary' to='/' onClick={resetGame}>
                  Main Menu
                </Link>
                <a
                  rel='noreferrer'
      ...
      <div className='game-data'>
        <h1 className="player-turn">Player {currentGameContext.currentPlayer}'s Turn</h1>
        <h2 className="turn-phase">{currentGameContext.turnPhase == 1 ? (
          "Play current piece!"
        ) : (
          "Choose your opponent's piece!"
        )}</h2>
        <CurrentPiece />
      </div>
    </div>
